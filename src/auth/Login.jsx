...
const Login = () => {
  ...
  return (
    <div className="py-12 mb-12  flex flex-col items-center justify-center w-full h-screen ">
      {/* personal details */}

      <div className="bg-white px-10 py-11 mt-50 w-[500px] rounded-2xl border-2 border-gray-200">
        {/* Sign in section */}
